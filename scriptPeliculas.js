function cargarPeliculas() {
    fetch("peliculas.json") //fetch para sacar archivos del json
        .then(respuesta => respuesta.json()) //almacenamos la respuesta
        .then(function(salida) { //funcion anonima para crear el div
            let contenedor = document.getElementById("peliculas"); //se obtiene el id del div que esta en el documento
